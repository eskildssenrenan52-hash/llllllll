    ...
    if (stepTile === 'portal' || stepTile === 'haunted_portal' || stepTile === 'sky_portal' || stepTile === 'crystal_portal') {
      ...
      if (stepTile === 'portal') {
        ...
        // Cidade -> destinos selecionados por proximidade do portal
          ...
          // Determina destino baseado na posicao do portal (~16px = 1 tile, mapa 500x500)
          const tx = ptx, ty = pty
          // Novos biomas: Montanha Nevada (60,60) e Ruinas Antigas (440,440)
        ...
        if      (curId === 'catacombs1') portalTarget = 'catacombs2'  // descer para andar 2
